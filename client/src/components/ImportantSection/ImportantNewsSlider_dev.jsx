...
const ImportantNewsSlider = ({ data }) => {
  ...
  const currentImageData = data[currentSlide];
  console.log(currentImageData)
  const isImageLoaded = Boolean(loadedImages[currentImageData?.image_url]);
        ...
        >
          ...
          {/* {isImageLoaded ? ( */}
            <img
              ...
              alt='slide'
              loading="lazy"
              onLoad={() => handleImageLoad(currentImageData.id)}
            />
            {/* ) : null} */}
             <div
